...
public class no5 {
    public static void main(String[] args) {
        bangundatarBalik[] bgn_dtr = new bangundatarBalik[501];
        System.out.println("\tL\tKel");

        for (int i = 1; i < bgn_dtr.length; i++) {
            bgn_dtr[i] = new bangundatarBalik(i);
            ...
            System.out.println("balok ke-" + i + " luas permukaan= " + bgn_dtr[i].l_a_balok() + " & volume = " + bgn_dtr[i].volume_balok());
        }
    }
}
