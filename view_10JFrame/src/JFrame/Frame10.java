...
public class Frame10 extends FrameParent {

    public Frame10(FrameSwitcher fSwitcher) {
        super(fSwitcher);
        setCurrentText(lblCurrent);
        fSwitcher.previousFrame = 10;
    }
    ...
    private void initComponents() {
        ...
        jToggleButton8.setText("jToggleButton3");
